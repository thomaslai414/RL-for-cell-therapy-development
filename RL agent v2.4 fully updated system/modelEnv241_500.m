classdef modelEnv241_500 < rl.env.MATLABEnvironment
    ...
    methods              
        ...
        function InitialObservation = reset(this)           
            if this.useCustom == false
                ...
                % change normalization ./5000000 -> 100k, ./1000000 -> 500k
                InitialObservation = [this.initcon(pickanumber)./1000000,1];
